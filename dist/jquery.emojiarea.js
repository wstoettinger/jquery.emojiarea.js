...
/******/ 	var hotCurrentHash = "3a5c96b817833aff4b20"; // eslint-disable-line no-unused-vars
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * This EmojiArea is rewritten from ground up an based on the code emojiarea from Brian Reavis <brian@diy.org>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      *
  ...
  _createClass(EmojiArea, [{
    ...
    value: function replaceSelection(content) {
      ...
      if (range) {
        ...
        insert = document.importNode(insert, true);
        ...
        if (e.nodeType === 1 || e.nodeType === 11) {
          ...
          if (_this.o.type !== 'unicode') {
            ...
            parsed = parsed.replace(_this.o.unicodeRegex, function (match, unicode) {
              return _Emoji2.default.checkUnicode(unicode) ? EmojiArea.createEmoji(null, _this.o, unicode) : unicode;
            });
          }

          parsed = parsed.replace(_this.o.emojiRegex, function (match, alias) {
            return _Emoji2.default.checkAlias(alias) ? EmojiArea.createEmoji(alias, _this.o) : ':' + alias + ':';
          });
    ...
    value: function createEmoji(alias) {
      ...
      alias = alias || _Emoji2.default.aliasFromUnicode(unicode);
      unicode = unicode || _Emoji2.default.unicodeFromAlias(alias);
    ...
    value: function generateEmojiImg(unicode, alias) {
      ...
      var data = _Emoji2.default.dataFromAlias(alias, true);
      var group = _Emoji2.default.groups[data[2]];
    ...
    value: function createImageStyles() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : EmojiArea.DEFAULTS;
      ...
      for (var g = 0; g < _Emoji2.default.groups.length; g++) {
        var group = _Emoji2.default.groups[g];
        var d = group.dimensions;

        for (var e = 0; e < group.items.length; e++) {
          var key = group.items[e];
          var emojiData = _Emoji2.default.data[key];
          if (!emojiData) continue;
          var alias = emojiData[_Emoji2.default.EMOJI_ALIASES];
          if (alias) {
            var row = e / d[0] | 0;
            var col = e % d[0];
    ...
    value: function injectImageStyles() {
      ...
      (0, _jquery2.default)('<style type="text/css">' + EmojiArea.createImageStyles(options) + '</style>').appendTo("head");
    }
  }]);
 ...
 *
 */
Emoji.initialize = function () {
  Emoji.aliases = {};
  Emoji.unicodes = {};

  var dataKeys = Object.keys(Emoji.data);
  for (var e = 0; e < dataKeys.length; e++) {
    var key = dataKeys[e];
    var emojiData = Emoji.data[key];
    if (emojiData) {
      var code = emojiData[Emoji.EMOJI_UNICODE];

      Emoji.aliases[emojiData[Emoji.EMOJI_ALIASES]] = key;
      Emoji.unicodes[code] = key;

      // also create unicode aliases for modified versions of emoticons
      if (code.length <= 2) {
        Emoji.unicodes[code + Emoji.MODIFIER_TEXT] = key;
        Emoji.unicodes[code + Emoji.MODIFIER_EMOJI] = key;
        if (Emoji.MODIFIER) {
          // force text or emoji presentation with modifier
          emojiData[Emoji.EMOJI_UNICODE] = code + Emoji.MODIFIER;
        }
      }
    }
  }
...
Emoji.checkAlias = function (alias) {
  return Emoji.aliases.hasOwnProperty(alias);
};

Emoji.checkUnicode = function (alias) {
  return Emoji.unicodes.hasOwnProperty(alias);
};
 ...
 * @returns {*}
 */
Emoji.unicodeFromAlias = function (alias) {
  if (alias) {
    var key = Emoji.aliases[alias];
    var emojiData = Emoji.data[key];
    if (emojiData && emojiData[Emoji.EMOJI_UNICODE]) return emojiData[Emoji.EMOJI_UNICODE];
  }
  return null;
};

Emoji.unicodeFromAscii = function (ascii) {
  return Emoji.unicodeFromAlias(Emoji.aliasFromAscii(ascii));
};

Emoji.aliasFromUnicode = function (unicode) {
  if (unicode) {
    var key = Emoji.unicodes[unicode];
    var emojiData = Emoji.data[key];
    if (emojiData && emojiData[Emoji.EMOJI_ALIASES]) return emojiData[Emoji.EMOJI_ALIASES];
  }
  return null;
};

Emoji.aliasFromAscii = function (ascii) {
  return Emoji.ascii[ascii] || null;
};

Emoji.EMOJI_UNICODE = 0;
Emoji.EMOJI_ALIASES = 1;
Emoji.MODIFIER_TEXT = '\uFE0E';
Emoji.MODIFIER_EMOJI = '\uFE0F';
Emoji.MODIFIER = Emoji.MODIFIER_EMOJI;
...
(0, _jquery2.default)(function () {
  ...
  if (_EmojiArea2.default.INJECT_STYLES) {
    _EmojiArea2.default.injectImageStyles();
  }
});
    ...
    value: function loadEmojis(tabs) {
      ...
      for (var g = 0; g < _Emoji2.default.groups.length; g++) {
        ...
        for (var e = 0; e < group.items.length; e++) {
          ...
          if (_Emoji2.default.data.hasOwnProperty(emojiId)) {
            (function () {
              var word = _Emoji2.default.data[emojiId][_Emoji2.default.EMOJI_ALIASES] || '';
